...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/7/7f/Big-Ω-notation.png" title="Lower bound: f(x) = Ω(g(x)). Source: Wikimedia Commons." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/4/4b/Big-θ-notation.png" title="Tight bound: f(x) = Θ(g(x)). Source: Wikimedia Commons." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/0/0c/ComputerMemoryHierarchy.svg" title="Figure 3: Memory hierarchy in a computer system. Source: Wikimedia Commons." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/1/1e/Comparison_of_sorting_algorithms.png" title="Figure 4: Comparison of the number of operations across different sorting algorithms. Source: Wikimedia Commons." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/1/1a/Análisis_de_algoritmos_-_ordenass.svg" title="Example of a comparative analysis of sorting algorithms. Source: Wikimedia Commons." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/f/f1/Binary_search_vs_Linear_search_example_svg.svg" title="Comparison between Linear Search and Binary Search. Source: Wikimedia Commons." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/6/64/Binary_Search_Depiction.svg" title="Step-by-step depiction of Binary Search. Source: Wikimedia Commons." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/8/84/Hash_table_average_insertion_time.png" title="Average insertion time in a Hash Table. Source: Wikimedia Commons." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/d/da/Binary_search_tree.svg" title="Example of a Binary Search Tree (BST). Source: Wikimedia Commons." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/a/a2/Directed.svg" title="Example of a Directed Graph. Source: Wikimedia Commons." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/d/d5/QUEUE_VS_STACK.svg" title="Comparison between a Queue (FIFO) and a Stack (LIFO). Source: Wikimedia Commons." >}}
