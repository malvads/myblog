...
{{< figure src="https://static.afteracademy.com/images/comparison-of-sorting-algorithms-compare1-18082c14f960abf3.png" title="Figura 2: Comparación del número de operaciones en distintos algoritmos de ordenamiento." >}}
...
{{< figure src="https://carolinacheuquiante.files.wordpress.com/2012/06/imagen1.png?w=300&h=201" title="Figura 3: Ejemplo de análisis comparativo de algoritmos de ordenamiento." >}}
...
{{< figure src="https://d18l82el6cdm1i.cloudfront.net/uploads/bePceUMnSG-binary_search_gif.gif" title="Figura 4: Comparación entre Búsqueda Lineal y Búsqueda Binaria." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/c/c8/Bubble-sort-example-300px.gif" title="Figura 5: Visualización del algoritmo Bubble Sort. Fuente: Wikimedia Commons." >}}
...
{{< figure src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTy96cpSdwgYFg_OZzvTMqKIu7iYGDuK3zefw&s" title="Representación paso a paso de la Búsqueda Binaria." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/e/e6/Merge_sort_algorithm_diagram.svg" title="Figura 6: Diagrama del algoritmo Merge Sort. Fuente: Wikimedia Commons." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/1/1c/Hash_table_average_insertion_time.png" title="Figura 7: Tiempo promedio de inserción en una Tabla Hash." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/d/da/Binary_search_tree.svg" title="Figura 8: Ejemplo de un Árbol Binario de Búsqueda (BST)." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/a/a2/Directed.svg" title="Figura 9: Ejemplo de un Grafo Dirigido." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/QUEUE_VS_STACK.svg/3840px-QUEUE_VS_STACK.svg.png" title="Figura 10: Comparación entre una Cola (Queue/FIFO) y una Pila (Stack/LIFO)." >}}
